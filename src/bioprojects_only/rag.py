...
def build_query_engine(k=30, similiarity_cutoff=0.5, outdir="./bioprojects-rag-data", model="models/gemini-2.0-flash-lite"):
    # -- Retriever
...
if __name__ == "__main__":
    ...
    query_engine = build_query_engine(outdir="./bioprojects-rag-data")
